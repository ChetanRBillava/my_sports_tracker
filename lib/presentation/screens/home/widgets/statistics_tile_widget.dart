...
Widget statisticsTileWidget({
  ...
  ScreenshotControllers screenshotController = ScreenshotControllers();
            ...
            child: uiUtilityPackage.customCard(
              ...
              onLongPress: () {
                ...
                screenshotController.captureScreenshot(
                  ...
                  key: statisticsTileModel.title.toLowerCase().replaceAll(
                    ' ',
                    '_',
                  ),
              ...
              widget: SizedBox(
                ...
                child: Column(
                  children: [
                    ...
                    !(homeScreenState.mainStatTileFlags[statisticsTileModel
                                .title
                                .toLowerCase()
                                .replaceAll(' ', '_')] ??
                            true)
                                          ...
                                          : Padding(
                                            ...
                                            child: Row(
                                              children: [
                                                uiUtilityPackage.customText(
                                                  text:
                                                      '#1 ${getLabel(type: statisticsTileModel.stats![statIndex].type!, player: statisticsTileModel.stats![statIndex].players![0])}',
                                                  fontSize: TextSize.title,
                                                  overrideColor:
                                                      appThemeState
                                                          .themeClass
